...
### 2026-05-03 — הסרת שנות אזכרה ריקות (1997, 2001, 2006, 2021)
**הקשר:** תיראן ביקש להוריד placeholder-ים של שנים שאין להן עדיין תמונות, כדי שלא יופיעו ככרטיסים ריקים בעמוד הראשי.
**מה שונה:** ב-`site/js/site.js`, בתוך הפונקציה `setupAzkarotGrid` ב-object `FORMAL`, הוסרו 4 שנים: 1997, 2001, 2006, 2021. הטקסטים שלהן נשמרו כהערה מעל ה-object כדי שיהיה קל לשחזר אם נחוץ.
**מה זה אומר בפועל:** ברגע שתיראן יעלה תמונות לתיקייה `site/imgs/memorials/dd_mm_yyyy/` עבור אחת מהשנים האלה, ה-CI ייצור manifest entry והכרטיס יופיע אוטומטית — בלי הצורך לערוך עוד את הקוד. אם הוא רוצה שהכרטיס יציג גם prose מותאם, הוא צריך להחזיר את אותה השנה ל-`FORMAL` (השורה כבר מוכנה כהערה). השנים שנשארות פעילות: 2011, 2016, 2026.

### 2026-05-03 — יישור hero + מערכת manifest אוטומטית לתמונות
**הקשר:**
1. תיראן החליף את `imgs/insignia/shaked.png` בקובץ עם פרופורציות שונות, וכל ה-hero (נרות