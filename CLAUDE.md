...
### 2026-05-03 — חיזוק לייבלים פונקציונליים בסקציית ההספדים
**הקשר:** אחרי הבהרת `--text/2/3`, תיראן ציין שכפתורי הסינון (משפחה / חברים / מפקדים / לוחמים) והלייבלים מעל קבוצות ההספדים עדיין נראים חלשים.
**הסיבה:** הם השתמשו ב-`--text3` שמיועד לאלמנטים קישוטיים (footer, captions, רמז גלילה), אבל אלה דווקא אלמנטים פונקציונליים (UI ניווט). הבחירה הנכונה ה�