...
### 2026-05-03 — הכהיה עדינה של טקסט הגוף
**הקשר:** תיראן זיהה שהבעיה הראשונית של "טקסט נבלע ברקע השחור" לא הייתה בכותרות הצהובות — אלא דווקא בטקסט הגוף שהיה בהיר מדי (`#f0ead8`, קונטרסט ~14.5:1, מסנוור מעט).
**מה שונה:** `--text` הועבר מ-`#f0ead8` ל-`#d4cdb8` ב-`site/index.html` וב-`site/memorial.html`. אותו גוון קרם חמים, אבל פחות בוהק; קונטרסט יורד ל-~11:1 — עדיין הרבה מעל סף נגישות AAA.
**רגרסיה אפשרית:** אם הטקסט עכשיו מרגיש יותר מדי כהה (קרוב מדי ל-`--text2: #a89e88`), אפשר להעלות טיפה ל-`#dfd8c2` או לחזור ל-`#f0ead8`.
**הערה לעתיד:** את הניסוי של החלפת ה**כותרות** מזהב לסגול לא צריך לחזור עליו — ההחלטה הייתה לא לשנות צבע, אלא להוריד את הבוהק של הטקסט הרגיל. הכותרות הזהובות נשארו `#c9a84c` כמו שהיו.

### 2026-05-03 — תמיכה בהקלטות יוטיוב לאזכרה (`youtube.txt`)
**הקשר:** האזכרה של 2020 התקיימה בזום בגלל הקורונה ויש ה